...
export default {
  ...
  var showVideo = false;
    ...
    onMounted(() => {
      ...
      dataNews.append("newsId", newsId.newsId);

       axios
        .post(
          "http://archonnews.com/piaBDMBack/includes/news_inc.php?action=selectNewsRedaccionById",
          dataNews,
          {
            headers: {
              "Content-Type": "application/json",
        ...
        .then((response) => {
          ...
          console.log(response.data[0][0]);
           noticia.value = response.data[0];
           console.log("valor de noticia:");
           console.log(noticia.value[0].TITLE);

          title.value = noticia.value[0].TITLE;
          desc.value = noticia.value[0].LEAD_TEXT;
          texto.value = noticia.value[0].NEWS_TEXT;
          pais.value = noticia.value[0].COUNTRY;
          estado.value = noticia.value[0].STATE;
          ciudad.value = noticia.value[0].CITY;
